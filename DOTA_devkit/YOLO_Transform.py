...
if __name__ == '__main__':
    ...
    dota2LongSideFormat('../data/UCAS_AOD/yolo_test/images',
                        '../data/UCAS_AOD/yolo_test/labelTxt',
                        '../data/UCAS_AOD/yolo_test/labels',
                        util.HRSC2016)

    # drawLongsideFormatimg(imgpath='../data/UCAS_AOD/yolo_test/images',
    #                       txtpath='../data/UCAS_AOD/yolo_test/labels',
    #                       dstpath='../data/UCAS_AOD/yolo_test/save',
    #                       extractclassname=util.HRSC2016)